Feature: code-breaker submits guess
  ...
  of 1134 against a secret code of 1234 would get three '+' signs: one for each of
  the exact matches in the first, third and fourth positions. The number match in 
